...
class ClassroomResource extends Resource
{
    ...
    protected static string|BackedEnum|null $navigationIcon = 'heroicon-o-users-circular';
    protected static string|BackedEnum|null $activeNavigationIcon = 'heroicon-s-users-circular';
