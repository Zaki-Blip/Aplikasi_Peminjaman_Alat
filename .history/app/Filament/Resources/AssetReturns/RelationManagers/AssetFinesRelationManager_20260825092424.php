                        ...
                        if($state === 'lost')
                            {
                                ...
                                $set = ('notes','Charged 100% of purchase price due to asset lost')
                            }elseif('state' === 'late')
                            {
                            ...
                            if($returned->gt($due))
                                {
                                    ...
                                    $set('amount',$days * 5000);
                                    $set('notes','Late return by ($days), Rate: IDR 5.000/day');
                                }else{
                                    $set('amount',0);
                                    $set('notes','Please describe the damage and.');
                                }
                    }
                        elseif($state === 'damaged'){
                            $set('amount',0);
                            $set('notes','Late delay detected, Returned on time.');
                        }
                    ),
